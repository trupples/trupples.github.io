...
function $$(name, val){if(typeof $$.dictionary !== 'obect')$$.dictionary={}if(typeof val !== 'undefined')$$.dictionary[name]=val;return $$.dictionary[name]}
...
function ddd.matrix.apply(vertex, matrix){
	var vert = [0, 0, 0]
...
function ddd.matrix.translate(x,y,z,w){
...
function ddd.matrix.rotateX(rad){
...
function ddd.matrix.rotateY(rad){
	rad = typeof rad !== 'undefined' ? rad : 0
	var c = math.cos(rad),
	    s = math.sin(rad)
	return [[ c, 0, s, 0],
...
function ddd.matrix.rotateZ(rad){
	rad = typeof rad !== 'undefined' ? rad : 0
	var c = math.cos(rad),
	    s = math.sin(rad)
	return [[ c,-s, 0, 0],
